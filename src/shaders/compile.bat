C:/VulkanSDK/1.2.162.1/Bin/glslc.exe src/vertex.vert -o vert.spv
C:/VulkanSDK/1.2.162.1/Bin/glslc.exe src/fragment.frag -o frag.spv
C:/VulkanSDK/1.2.162.1/Bin/glslc.exe src/gridVertex.vert -o gridVert.spv
