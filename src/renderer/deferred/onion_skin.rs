...
impl<'a> OnionSkinRenderPass<'a> {
    ...
    pub unsafe fn record_ghost_pass(
        &self,
        command_buffer: vk::CommandBuffer,
        image_index: usize,
    ) -> Result<()> {
        self.begin_ghost_render_pass(command_buffer);
        self.bind_ghost_pipeline_and_state(command_buffer);
        self.draw_ghosts(command_buffer, image_index)?;
        self.device.cmd_end_render_pass(command_buffer);
        Ok(())
    }

    pub unsafe fn record_composite_pass(&self, command_buffer: vk::CommandBuffer) {
        self.begin_composite_render_pass(command_buffer);

        self.device.cmd_bind_pipeline(
            command_buffer,
            vk::PipelineBindPoint::GRAPHICS,
            self.resources.composite_pipeline.pipeline,
        );
        ...
        self.device.cmd_bind_descriptor_sets(
            command_buffer,
            vk::PipelineBindPoint::GRAPHICS,
            self.resources.composite_pipeline.pipeline_layout,
            0,
            &[self.resources.composite_descriptor_set],
            &[],
        );
    ...
    unsafe fn begin_ghost_render_pass(&self, command_buffer: vk::CommandBuffer) {
        ...
        let render_pass_info = vk::RenderPassBeginInfo::builder()
            .render_pass(self.resources.ghost_render_pass)
            .framebuffer(self.resources.ghost_framebuffer)
    ...
    unsafe fn begin_composite_render_pass(&self, command_buffer: vk::CommandBuffer) {
        let render_area = vk::Rect2D::builder()
            .offset(vk::Offset2D::default())
            .extent(vk::Extent2D {
                width: self.resources.width,
        ...
        let render_pass_info = vk::RenderPassBeginInfo::builder()
            .render_pass(self.resources.composite_render_pass)
            .framebuffer(self.resources.composite_framebuffer)
            .render_area(render_area)
            .clear_values(&[]);
    ...
    unsafe fn bind_ghost_pipeline_and_state(&self, command_buffer: vk::CommandBuffer) {
        self.device.cmd_bind_pipeline(
            command_buffer,
            vk::PipelineBindPoint::GRAPHICS,
            self.resources.ghost_pipeline.pipeline,
        );
    ...
    unsafe fn draw_ghosts(
        ...
        let pipeline_layout = self.resources.ghost_pipeline.pipeline_layout;
