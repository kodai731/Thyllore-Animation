...
use crate::ecs::resource::{
    FlameBuffer, FlameGpuState, FlameHistorySnapshotState, FlameRenderTargets,
};
...
use thyllore_vulkan_core::command::{begin_single_time_commands, end_single_time_commands};
use thyllore_vulkan_core::core::RRDevice;
use thyllore_vulkan_core::resource::gpu_resource::GpuResource;
use thyllore_vulkan_core::resource::hdr_buffer::HDR_FORMAT;
use thyllore_vulkan_core::resource::render_target_storage::{RenderTargetKey, RenderTargetStorage};
...
impl GpuResource for FlameBuffer {
