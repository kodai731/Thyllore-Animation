...
- `TracePush` (a push constant block with no CPU export) is generated by `crates/thyllore-vulkan-core/build.rs` from
  the SPIR-V that declares it (`GPU_BLOCKS` there) into `trace_push.rs`, included by `renderer/trace_push.rs`.
