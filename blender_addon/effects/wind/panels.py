...
VIEW3D_PT_thyllore_wind_advanced = effect_properties.build_effect_advanced_panel(
    "wind", "VIEW3D_PT_thyllore_wind"
)
...
VIEW3D_PT_thyllore_wind_debug = effect_properties.build_effect_child_panel(
    "wind", "VIEW3D_PT_thyllore_wind", "debug", "Debug", _debug_draw
)
