...
def register():
    ...
    bpy.utils.register_class(panels.VIEW3D_PT_thyllore_flame_advanced)
    bpy.utils.register_class(panels.VIEW3D_PT_thyllore_flame_debug)
...
def unregister():
    ...
    bpy.utils.unregister_class(panels.VIEW3D_PT_thyllore_flame_debug)
    bpy.utils.unregister_class(panels.VIEW3D_PT_thyllore_flame_advanced)
