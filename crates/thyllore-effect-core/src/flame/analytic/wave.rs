...
//! (flameWaveNoiseSum / flameWaveOccupancySegments in noise_field.slang /
//! radial_integral.slang) live in thyllore-render-debug (test-only crate).
...
/// Mirror of flameWaveJitterState in noise_field.slang.
