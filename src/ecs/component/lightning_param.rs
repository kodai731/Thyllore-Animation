...
use super::lightning::LightningEffect;
...
impl LightningParam {
    pub const ALL: [LightningParam; 44] = [
        ...
        LightningParam::GlowRatio,
        LightningParam::GlowIntensity,
        LightningParam::GlowColorR,
        LightningParam::GlowColorG,
        LightningParam::GlowColorB,
    ...
    pub const fn code(self) -> u16 {
        match self {
            ...
            LightningParam::GlowRatio => 788,
            LightningParam::GlowIntensity => 789,
            LightningParam::GlowColorR => 790,
            LightningParam::GlowColorG => 791,
            LightningParam::GlowColorB => 792,
    ...
    pub const fn display_name(self) -> &'static str {
        match self {
            ...
            LightningParam::GlowRatio => "Glow Ratio",
            LightningParam::GlowIntensity => "Glow Intensity",
            LightningParam::GlowColorR => "Glow Color R",
            LightningParam::GlowColorG => "Glow Color G",
            LightningParam::GlowColorB => "Glow Color B",
    ...
    pub const fn cli_name(self) -> &'static str {
        match self {
            ...
            LightningParam::GlowRatio => "glow_ratio",
            LightningParam::GlowIntensity => "glow_intensity",
            LightningParam::GlowColorR => "glow_color_r",
            LightningParam::GlowColorG => "glow_color_g",
            LightningParam::GlowColorB => "glow_color_b",
    ...
    pub const fn scene_name(self) -> &'static str {
        match self {
            ...
            LightningParam::GlowRatio => "GlowRatio",
            LightningParam::GlowIntensity => "GlowIntensity",
            LightningParam::GlowColorR => "GlowColorR",
            LightningParam::GlowColorG => "GlowColorG",
            LightningParam::GlowColorB => "GlowColorB",
    ...
    pub const fn debug_value_range(self) -> (f32, f32) {
        match self {
            ...
            LightningParam::GlowRatio => (1.0, 20.0),
            LightningParam::GlowIntensity => (0.0, 100.0),
            LightningParam::GlowColorR => (0.0, 1.0),
            LightningParam::GlowColorG => (0.0, 1.0),
            LightningParam::GlowColorB => (0.0, 1.0),
